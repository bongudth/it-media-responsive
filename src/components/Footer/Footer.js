    ...
    return (
        <div className="footer-container">
            ...
            <div className="footer-infomation">
                ...
                <a href="https://www.facebook.com/itmediadut" target="_blank" className="footer-infomation-content">facebook.com/itmediadut</a>
            </div>
            <div className="footer-infomation">
                <div className="footer-infomation-label">Website:</div>
                <a href="http://dut.udn.vn/KhoaCNTT" target="_blank" className="footer-infomation-content">dut.udn.vn/KhoaCNTT</a>
            </div>
            <div className="footer-infomation">
